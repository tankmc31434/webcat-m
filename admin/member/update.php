...
if ($_REQUEST['execute'] == "insert") {
	...
	$update = array();
	$update[] = $table . "_username='" . $_POST["Username"] . "'";
	$update[] = $table . "_password='" . encodeStr($_POST['Password']) . "'";
	$update[] = $table . "_fname='" . $_POST["name"] . "'";
	$update[] = $table . "_lname='" . $_POST["lastname"] . "'";
