...
$slect_data2 = array();
$slect_data2[$tablerepost . "_id as " . substr("_id", 1)] = "";
$slect_data2[$tablerepost  . "_subject as " . substr("_subject", 1)] = "";
$slect_data2[$tablerepost  . "_pic as " . substr("_pic", 1)] = "";
$slect_data2[$tablerepost  . "_credate as " . substr("_credate", 1)] = "";
$slect_data2[$tablerepost  . "_text as " . substr("_text", 1)] = "";
$sql2 = "SELECT \n" . implode(",\n", array_keys($slect_data2)) . " FROM " . $tablerepost . " WHERE " . $tablerepost . "_cid = '" . $_REQUEST['id'] . "' ";


$sql2 .= "ORDER BY " . $tablerepost . "_credate DESC ";
$sql2 .= "LIMIT 0,5";
                                    ...
                                    <div class="col-lg-auto mt-lg-0 mt-sm-4 mt-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-auto col-md col-6 text-lg-start text-end ps-0">
                                                <div class="back">
                                                    <a href="help-repost.php?id=<?php echo $val[0] ?>" class="btn btn-outline-primary btn-lg rounded-pill fw-bold">ดูเบาะแส</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-auto col-md col-6 text-lg-start text-end ps-0">
                                                <div class="back">
