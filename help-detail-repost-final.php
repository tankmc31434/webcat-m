...
$slect_data[$table  . "_text as " . substr("_text", 1)] = "";
                ...
                <div class="wrapper">
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="index.php" class="link" style="color:white;">หน้าหลัก</a><span style="color:white;"> >เบาะแสสัตว์เลี้ยงสูญหาย</span>
                        </div>
            ...
            <div class="default-page news-page pb-0" style="margin: 2rem 0;">
                <div class="detail-body">
                    <div class="container-xl">
                        ...
                        <?php if (is_file('upload/track/repost/' . $val[3])) { ?>
                            <div class="gallery-block">
                                <div class="row justify-content-center">
                                    <div class="col-md-10">
                                        <div class="ratio ratio-16x9">
                                            <?php if (is_file('upload/track/repost/' . $val[3])) { ?>
                                                <img src="<?php echo $core_template; ?>upload/track/repost/<? echo $val[3] ?>" alt="" />
                                            <?php } else { ?>
                                            <?php } ?>
                                        </div>
                                    </div>
                        ...
                        <div class="subtitle typo-sm fw-bold text-secondary">
                            รายละเอียด : <span class="fw-normal text-dark"><? echo $val[2] ?></span>
                        </div>
