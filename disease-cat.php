...
<!-- ใช้สำหรับแสดงรายการโรคที่พบในแมวทั้งหมดในระบบ พร้อมฟังก์ชันค้นหาและแบ่งหน้า ผู้ใช้สามารถดูรายละเอียดโรคแต่ละรายการได้ -->
                                                ...
                                                <? foreach ($query as $Key) { ?>
                                                    <div class="col-xxl-4 col-sm-6">
                                                        <div class="wrapper" style="border-radius:40px">
                                                            <a href="disease-cat-detail.php?id=<?php echo $Key[0] ?>" class="link">
                                                                <div class="thumbnail">
                                                                    <figure class="cover">
